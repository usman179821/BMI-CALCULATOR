...
class SliderVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    let photos = ["bmiImageOne", "bmiImageTwo", "bmiImageThree"]
    ...
    @IBAction func TappedBtn(_ sender: Any) {
        ...
        let vc = storyboard?.instantiateViewController(withIdentifier: "CalculateViewController") as! CalculateViewController
